...
if(isset($_POST['obrisi'])){
    ...
    if($db->obrisi($knjiga)){
        $poruka = "Uspesno obrisana knjiga";
    }else{
        $poruka = "Neuspesno obrisana knjiga";
    }
        ...
        <div class="container">
            ...
            <div class="row">
                <form method="post" action="">
                    ...
                    <hr/>
                    <button type="submit" name="obrisi">Obrisi knjugu</button>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 text-center text-md-end">
                        "Tri dana nemoj čitati knjige i tvoje će reči izgubiti lepotu"
                    </div>
                </div>
            </div>
        </div>
