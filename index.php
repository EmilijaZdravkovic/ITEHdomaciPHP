        ...
        <div class="row gx-0 d-none d-lg-flex">
            <div class="col-lg-7 px-5 text-start">
                <div class="h-100 d-inline-flex align-items-center py-3 me-3">
                    ...
                    <a class="text-body px-2" href="mailto:info@example.com"><i class="fa fa-envelope-open text-primary me-2"></i>moja-biblioteka@gmail.com</a>
                </div>
            </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                ...
                <h1 class="display-5 mb-4">Lična arhiva</h1>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <label for="procitano">Procitano</label>
                    <select class="form-control" id="procitano">
                        <option value="SVE">Sve knjige</option>
                        <option value="true">Procitane knjige</option>
                        <option value="false">Neprocitane knjige</option>
                    </select>
                </div>
                <div class="col-md-6">
                    <label for="sort">Sortiraj po oceni</label>
                    <select class="form-control" id="sort">
                        <option value="asc">Od najgore ka najboljoj</option>
                        <option value="desc">Od najbolje ka najgoroj</option>
                    </select>
                </div>

                <div class="cols-md-12" style="padding-top: 20px">
                    <button class="form-control btn-warning" onclick="pretrazi()">Pretrazi knjige</button>
                </div>
            </div>
            <br/>
            <br/>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 text-center text-md-end">
                        "Onaj ko ne voli da čita nije pronašao knjigu za sebe."
                    </div>
                </div>
            </div>
        </div>
